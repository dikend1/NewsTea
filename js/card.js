...
inputComment.addEventListener("keydown", (e) => {
    if (e.key === "Enter" && inputComment.value.trim() !== "") {
        ...
        username.innerText = "some_new_user";
        ...
        dislikeDiv.className = "inside-like-comm";
        let dislikeBtn = document.createElement("button");
        dislikeBtn.className = "like-button";
        dislikeBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        likeComm.appendChild(dislikeDiv);
